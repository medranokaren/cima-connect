...
} // Efecto scroll para bloques móviles
...
// Asignar eventos a los botones o enlaces
document.getElementById("reparaciones-btn").addEventListener("click", function() {
    mostrarSeccion("reparaciones");
});
document.getElementById("casa-nueva-btn").addEventListener("click", function() {
    mostrarSeccion("casa-nueva");
});
